...
exports.createTestCase = (bot, message) => {
  bot.createConversation(message, function(err, convo) {
   ...
   convo.addQuestion({text: "Please choose the devices by thier Ids in comma separated (','), you want to add in test plan:",
    quick_replies: [{content_type: "text"}]
    }, (res, convo)=>{
